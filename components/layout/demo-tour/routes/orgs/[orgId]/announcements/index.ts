/**
 * Demo tour config for `/orgs/[orgId]/announcements`.
 */
...
export const demoTourConfig: DemoTourConfig = {
  ...
  steps: [
    {
      title: "[todo] Announcements",
      description: "[todo] Check the announcements page. The unique part here is the org updates feed.",

/**
 * Demo tour config for `/orgs/[orgId]/tools/calculator`.
 */
...
export const demoTourConfig: DemoTourConfig = {
  ...
  steps: [
    {
      title: "[todo] Calculator tool",
      description: "[todo] Check the calculator page. The unique part here is the calculation workspace.",

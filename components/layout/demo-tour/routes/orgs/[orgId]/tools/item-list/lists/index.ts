/**
 * Demo tour config for `/orgs/[orgId]/tools/item-list/lists`.
 */
...
export const demoTourConfig: DemoTourConfig = {
  ...
  steps: [
    {
      title: "[todo] Item lists",
      description: "[todo] Check the item lists page. The unique part here is the grouped list manager.",

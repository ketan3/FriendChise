/**
 * Demo tour config for `/orgs/[orgId]/tools/item-list/lists/[listId]`.
 */
...
export const demoTourConfig: DemoTourConfig = {
  ...
  steps: [
    {
      title: "[todo] Item list detail",
      description: "[todo] Check the item list detail page. The unique part here is the specific list editor.",

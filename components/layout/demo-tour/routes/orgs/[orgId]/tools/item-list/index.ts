/**
 * Demo tour config for `/orgs/[orgId]/tools/item-list`.
 */
...
export const demoTourConfig: DemoTourConfig = {
  ...
  steps: [
    {
      title: "[todo] Item list tool",
      description: "[todo] Check the item list page. The unique part here is the item-list management workspace.",

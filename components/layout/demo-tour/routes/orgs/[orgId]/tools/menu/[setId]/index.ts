/**
 * Demo tour config for `/orgs/[orgId]/tools/menu/[setId]`.
 */
...
export const demoTourConfig: DemoTourConfig = {
  ...
  steps: [
    {
      title: "[todo] Menu set detail",
      description: "[todo] Check the menu set detail page. The unique part here is the specific menu set editor.",

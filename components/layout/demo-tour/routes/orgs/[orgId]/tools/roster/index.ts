/**
 * Demo tour config for `/orgs/[orgId]/tools/roster`.
 */
...
export const demoTourConfig: DemoTourConfig = {
  ...
  steps: [
    {
      title: "[todo] Roster tool",
      description: "[todo] Check the roster page. The unique part here is the roster planning workspace.",

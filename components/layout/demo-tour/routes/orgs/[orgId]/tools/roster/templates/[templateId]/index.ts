/**
 * Demo tour config for `/orgs/[orgId]/tools/roster/templates/[templateId]`.
 */
...
export const demoTourConfig: DemoTourConfig = {
  ...
  steps: [
    {
      title: "[todo] Roster template detail",
      description: "[todo] Check the roster template detail page. The unique part here is the template editor.",

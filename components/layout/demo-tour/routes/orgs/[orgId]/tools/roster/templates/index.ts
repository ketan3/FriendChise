/**
 * Demo tour config for `/orgs/[orgId]/tools/roster/templates`.
 */
...
export const demoTourConfig: DemoTourConfig = {
  ...
  steps: [
    {
      title: "[todo] Roster templates",
      description: "[todo] Check the roster templates page. The unique part here is the reusable roster template list.",

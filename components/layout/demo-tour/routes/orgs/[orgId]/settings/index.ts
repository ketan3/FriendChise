/**
 * Demo tour config for `/orgs/[orgId]/settings`.
 */
...
export const demoTourConfig: DemoTourConfig = {
  ...
  steps: [
    {
      title: "[todo] Org settings home",
      description: "[todo] Check the settings home page. The unique part here is the org settings navigation.",

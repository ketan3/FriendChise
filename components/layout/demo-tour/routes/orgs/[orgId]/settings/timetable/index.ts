/**
 * Demo tour config for `/orgs/[orgId]/settings/timetable`.
 */
...
export const demoTourConfig: DemoTourConfig = {
  ...
  steps: [
    {
      title: "[todo] Timetable settings",
      description: "[todo] Check the timetable settings page. The unique part here is timetable-specific org configuration.",

---
title: Smoke Test Report — V1 Round 3
description: Third round smoke test report for the deployed V1 app
order: 8.4
---

# 🔥 Smoke Test Report — V1 Round 3
...
**Overall: ❌ FAIL — 5 new issues found**
...
| 60  | Task page toolbar position | A      | Toolbar buttons/components on right side | ❌ FAIL | New issue [#103](https://github.com/IvanTran-2001/FriendChise/issues/103) |
...
| 57  | Add-task popup layout (mobile) | A      | Popup scrollable, fills screen from top  | ✅ PASS | Fixed [#98](https://github.com/IvanTran-2001/FriendChise/issues/98) |
| 58  | Timetable responsive columns   | Either | Columns reduce as screen narrows (7→3→1) | ✅ PASS | Fixed [#99](https://github.com/IvanTran-2001/FriendChise/issues/99) |
...
| 59  | Member detail toolbar position | A      | Action buttons on right side               | ✅ PASS | Fixed [#100](https://github.com/IvanTran-2001/FriendChise/issues/100) |
...
| 56  | Notification panel layout (mobile) | B      | Top gap, fills bottom, scrollable | ✅ PASS | Fixed [#97](https://github.com/IvanTran-2001/FriendChise/issues/97) |
...
| 61  | Sidebar auto-close on navigate (mobile) | Either | Sidebar closes when tapping notifications/timetable | ❌ FAIL | New issue [#104](https://github.com/IvanTran-2001/FriendChise/issues/104) |
...
| #   | Test                                 | As who | What to check                                   | Status  | Notes                                                                     |
| --- | ------------------------------------ | ------ | ----------------------------------------------- | ------- | ------------------------------------------------------------------------- |
| 62  | Detail page max-width                | Either | Fixed max-width container, shrinks responsively | ❌ FAIL | New issue [#105](https://github.com/IvanTran-2001/FriendChise/issues/105) |
| 63  | Edit page responsive layout          | Either | Fixed size on desktop, stacks on mobile         | ❌ FAIL | New issue [#106](https://github.com/IvanTran-2001/FriendChise/issues/106) |
| 64  | Detail page avatar position (mobile) | Either | Photo appears at top of page on mobile          | ❌ FAIL | New issue [#107](https://github.com/IvanTran-2001/FriendChise/issues/107) |
...
| --- | ----------------------------------------------------------------------- | ----------- | ------ | --------------------------------------------------------------- |
| 60  | Task page toolbar buttons should be on the right                        | Bug         | All    | [#103](https://github.com/IvanTran-2001/FriendChise/issues/103) |
| 61  | Mobile sidebar stays open when tapping notifications/timetable links    | Bug         | Mobile | [#104](https://github.com/IvanTran-2001/FriendChise/issues/104) |
| 62  | Task/member detail pages need fixed max-width that shrinks responsively | Enhancement | All    | [#105](https://github.com/IvanTran-2001/FriendChise/issues/105) |
| 63  | Task/member edit pages need fixed size with responsive mobile layout    | Enhancement | All    | [#106](https://github.com/IvanTran-2001/FriendChise/issues/106) |
| 64  | Task/member detail page: photo should appear at top on mobile           | Enhancement | Mobile | [#107](https://github.com/IvanTran-2001/FriendChise/issues/107) |

---

## Next Steps

1. Fix 5 new issues (#103–#107)
2. Re-run as Round 4
